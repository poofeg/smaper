	...
	try
	{
		...
		while (marker < (off + len))
		{
			...
			switch (tlvType)
			{
				...
				//System.out.println("UNKNOWN TLV!!");
				//System.out.println(tlvType);
				//System.out.println(Util.byteArrayToString(tlvValue));
			}
		...
		{
			throw (new mipException(135, 2));
		}
		}
		catch (mipException e)
		{
			//System.out.println("Exception in DisconnectPacket...!");
			throw (new mipException(135, 2)); 
		}
	}
