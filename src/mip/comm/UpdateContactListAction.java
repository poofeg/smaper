...
public class UpdateContactListAction extends Action
{
	...
	*/
	...
	private boolean processPaket(Packet packet) throws mipException
	{
	...
	private void sendCLI_ADDSTART() throws mipException
	{
		Icq.c.sendPacket
		(
			new SnacPacket
	...
	private void sendCLI_ADDEND() throws mipException
	{
		Icq.c.sendPacket
		(
			new SnacPacket
	...
	private void sendGroupsList() throws mipException
	{
		Icq.c.sendPacket
		(
			new SnacPacket
	...
	static private void sendGroup(ContactListGroupItem group) throws mipException 
	{
		Icq.c.sendPacket
		(
			new SnacPacket
	...
	public void onEvent(int eventType) throws mipException
	{
		...
		case ON_ERROR:
			if (errorCode != 0) mipException.handleException(new mipException(errorCode, 0, true));
			//else mipException.handleException(new mipException(154, 3, true));
			ContactList.activate();
			break;
		}
	}
