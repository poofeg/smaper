...
import mip.comm.Icq;import mip.comm.Util;
...
// Generates int of money amount spent on connection
	...
	public class TrafficScreen
	{
		...
		public TrafficScreen()
		{
			...
			// Set colors
			mipUI.setColorScheme(trafficTextList);
			...
			trafficTextList.setSoftNames("Back", "Reset");
		}
		...
		{
			this.update(true);
			this.trafficTextList.activate(MIP.display);
		}
		
		// Is the traffic screen active?
		public boolean isActive()
		{
			return(MIP.display.getCurrent().equals(this.trafficTextList));
		}
